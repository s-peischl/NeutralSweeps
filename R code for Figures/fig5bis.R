...
plot(100*d,rel_coal,col=couleur,type="p",xlim=c(-120,120),ylim=c(0,2100),pch=19,cex.axis=2,cex.lab=2,cex=pointsize,ylab="average coalescence time",xlab="distance (cM)")  ## high rec
...
# 
# j <- 15
# abline(h = 2*(N0-Ne)*exp(-j/2/Ne) + 2*Ne,lty=2 , col="black" )
# 
# j <- 20
# abline(h = 2*(N0-Ne)*exp(-j/2/Ne) + 2*Ne,lty=2 , col="red" )
# 
# j <- 40
# abline(h = 2*(N0-Ne)*exp(-j/2/Ne) + 2*Ne,lty=2 , col="blue" )
# 
# abline(h=2*N0)
# 
# 
...
# 
# 
# in what follows we replace (tau+3000) by A such that the background level is reached at r = 0.5 
# 
# 
# library(pracma)
# 
...
# }
# 
# BG <- 2*(N0-Ne)*exp(-j/2/Ne) + 2*Ne
# 
# function11 <- function(x) sum(t*probaTa*exp(-2*N0/(x-tau)*sum_1minusX)) + x*(1-sum(exp(-2*N0/(x-tau)*sum_1minusX)*probaTa)) - BG
# 
# A <- findzeros(function11,tau+10,4*N0)
# 
# r <- seq(0,0.49*2*N0/(A-tau),0.0001)
# 
# TBhom <- r
# TBhet <- r
# 
...
# 
# r_corr <- r*(A-tau)/3000
# d_corr <- -log(1-2*r_corr)/2
# 
# 
# points(-d_corr*100,TBhet*A+TBhom,type="l",col="black",xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# points(d_corr*100,TBhet*A+TBhom,type="l",col="black",xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)
# 
# # points(-r,TBhet*(3000+tau)+TBhom,type="l",col=couleur,xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# # points(r,TBhet*(3000+tau)+TBhom,type="l",col=couleur,xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# 
...
# d_corr <- -log(1-2*r_corr)/2
# 
# points(-d_corr*100,TBhet*A+TBhom,type="l",col="red",xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# points(d_corr*100,TBhet*A+TBhom,type="l",col="red",xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)
# 
# # points(-r,TBhet*(3000+tau)+TBhom,type="l",col=couleur,xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# # points(r,TBhet*(3000+tau)+TBhom,type="l",col=couleur,xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# 
...
# d_corr <- -log(1-2*r_corr)/2
# 
# points(-d_corr*100,TBhet*A+TBhom,type="l",col="blue",xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# points(d_corr*100,TBhet*A+TBhom,type="l",col="blue",xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)
# 
# # points(-r,TBhet*(3000+tau)+TBhom,type="l",col=couleur,xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# # points(r,TBhet*(3000+tau)+TBhom,type="l",col=couleur,xlim=c(-0.001,0.001),ylim=c(0,1412),lwd=2)   #### ylim=c(0,3000),xlim=c(-0.5,0.5)
# 
