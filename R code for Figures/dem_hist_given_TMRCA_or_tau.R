...
dev.off()
library(ggplot2)
par(mfrow=c(1,5),mar=c(6,6.5,3,1))
...
plot(c(0,demog$V1),c(1,demog$V2),type="p",col="red",pch=19,main=expression(t[m]==10),cex.main=2*a,xlab=NA,cex.axis=2*a,cex.lab=2*a,ylab=NA,cex=pointSize_tau20,xaxt="n")
...
demog <- read.table("dem_given_TMRCA10.dat")
points(c(0,demog$V1),c(1,demog$V3),type="p",col="black",pch=19,main=expression(t[m]==20),cex.main=2*a,xlab=NA,cex.axis=2*a,cex.lab=2*a,ylab=NA,cex=pointSize_tau20,xaxt="n")
...
demog <- read.table("dem_given_TMRCA20.dat")
points(c(0,demog$V1),c(1,demog$V3),type="p",col="black",pch=19,main=expression(t[m]==20),cex.main=2*a,xlab=NA,cex.axis=2*a,cex.lab=2*a,ylab=NA,cex=pointSize_tau20,xaxt="n")
...
demog <- read.table("dem_given_TMRCA40.dat")
points(c(0,demog$V1),c(1,demog$V3),type="p",col="black",pch=19,main=expression(t[m]==20),cex.main=2*a,xlab=NA,cex.axis=2*a,cex.lab=2*a,ylab=NA,cex=pointSize_tau40,xaxt="n")
...
demog <- read.table("dem_given_TMRCA80.dat")
points(c(0,demog$V1),c(1,demog$V3),type="p",col="black",pch=19,main=expression(t[m]==20),cex.main=2*a,xlab=NA,cex.axis=2*a,cex.lab=2*a,ylab=NA,cex=pointSize_tau80,xaxt="n")
